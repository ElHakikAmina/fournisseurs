            ...
            <tbody>
              ...
              <tr>
                ...
                <form method="POST">
                  ...
                  <td><?php if($c['date_envoi']=='0000-00-00') echo'<input type="submit" name="envoyerMtn" class="btn btn-link text-danger" value="envoyez mtn?"/>'; else echo '<p class="text-success">'.$c['date_envoi'].'</p>'; ?></td>
                  <td><?php if($c['date_livraison']=='0000-00-00') echo'<input type="submit" name="livrerMtn" class="btn btn-link text-danger" value="Livrez mtn?"/>'; else echo '<p class="text-success">'.$c['date_livraison'].'</p>'; ?></td>
                </form>
                <td>
